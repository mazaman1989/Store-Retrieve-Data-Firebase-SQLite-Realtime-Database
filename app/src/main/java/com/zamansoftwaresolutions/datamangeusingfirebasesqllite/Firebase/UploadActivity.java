...
public class UploadActivity extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadName, uploadEmail, uploadPhone,uploadAddress;
    String imageURL;
    Uri uri;
    @Override
    ...
    private void uploadData() {
        ...
        DataClass dataClass = new DataClass(name, email, phone, imageURL,address);

        String currentDate = DateFormat.getDateTimeInstance().format(Calendar.getInstance().getTime());

        FirebaseDatabase.getInstance().getReference("User Registration").child(name)
