...
public class UpdateActivity extends AppCompatActivity {
    ...
    Button updateButton;
    EditText updateName, updateMobile, updateEmail,updateAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null){
            ...
            updateMobile.setText(bundle.getString("Mobile"));
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("User Registration").child(key);
    ...
    private void updateData() {
        ...
        DataClass dataClass = new DataClass(name, email, mobile, imageUrl,address);
